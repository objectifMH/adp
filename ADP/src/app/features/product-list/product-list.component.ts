...
export class ProductListComponent {
  @Input() products: any[] = []; // Liste des produits passée en entrée
    ...
    return [
      {
        ...
        alcoholContent: 40, // Nouvelle propriété : degré d'alcool
        stock: 50,
        rating: 4.5,
        reviews: 120,
        brand: 'Jack Daniels',
  ...
  sortCriteria: string = 'name'; // Critère de tri par défaut
  ...
  sortProducts(event: Event) {
    ...
    switch (criteria) {
      ...
      case 'discountedPrice':
        this.products.sort(
          (a, b) =>
            this.calculateDiscountedPrice(a) - this.calculateDiscountedPrice(b)
        );
        break;
      case 'volume':
        this.products.sort((a, b) => a.volume.localeCompare(b.volume));
        break;
      case 'alcoholContent':
        this.products.sort((a, b) => a.alcoholContent - b.alcoholContent);
        break;
      default:
        this.products.sort((a, b) => a.name.localeCompare(b.name));
        break;
